...
<template>
  <div class="bg-primary rounded-xl shadow-xl min-h-screen w-screen flex flex-col items-center justify-between ">
    <div class="w-full flex flex-col md:flex-row items-center justify-center p-8 relative">
      <!-- Contenedor de imágenes -->
      <div class="flex w-full max-w-7xl h-[60vh] md:h-[80vh] gap-3 items-center justify-center z-10">
        <div
        ...
        >
          ...
          <div
            ...
            :class="{
              'transform rotate-90 origin-center': expandedIndex !== index // Rota el texto cuando el panel está comprimido
            }"
          >
            {{ panel.text }}
          </div>
      ...
      <!-- Título principal -->
      <h2 class="text-5xl sm:text-6xl md:text-6xl font-extrabold leading-tight md:leading-none md:text-right m-8 text-white text-center">
  {{ $t("hitos.title") }}
</h2>
    </div>
  </div>
