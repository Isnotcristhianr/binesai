...
<template>
  ...
  >
    <div
      class="w-full flex flex-col md:flex-row items-center justify-center p-8 relative"
    >
      ...
      <!-- Título principal -->
      <h2
        class="text-5xl sm:text-6xl md:text-6xl font-extrabold leading-tight md:leading-none md:text-right m-8 text-white text-center"
      >
        {{ $t("hitos.title") }}
      </h2>
    </div>
